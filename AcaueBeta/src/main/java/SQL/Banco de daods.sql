...
CREATE SCHEMA `cflceb_acauebeta` ;

/*Criar Tabela de Usuarios Administradores*/
CREATE TABLE `cflceb_acauebeta`.`usuarios` (
...
CREATE TABLE `cflceb_acauebeta`.`posts` (
...
INSERT INTO `cflceb_acauebeta`.`usuarios` (`idUsuarios`, `Login`, `Password`) VALUES ('1', 'SYNC', '33910114');

/*Criar tabela de Emails*/
CREATE TABLE `cflceb_acauebeta`.`contato` (
...
CREATE TABLE `cflceb_acauebeta`.`cadastroemail` (
