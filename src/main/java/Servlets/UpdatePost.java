...
//Verificar se a imagem está nulla
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (alterar != null) {
            ...
            System.out.println("Local do arquivo : " +ArquivoName4);
            ...
            //Armazena imagem
            /**
             * for (int i = 0; i < 5; i++) { try (InputStream fileContent =
             * fileImgs[i].getInputStream()) { Files.copy(fileContent,
             * allPath[i], StandardCopyOption.REPLACE_EXISTING); } catch
