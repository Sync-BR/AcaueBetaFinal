            ...
            <main>
                ...
                <script>
                    document.getElementById('fileInput').addEventListener('change', function (event) {
                        ...
                        const filePath = event.target.value; // caminho completo do arquivo selecionado pelo usuário
                        const rootPath = filePath.split('\\')[0]; // Separando o root path do caminho completo do arquivo
                ...
                <section class="Content"> 
                    <%                        if (PostDao.UpdateAtualizado) {
                            ...
                            out.println("<label>Arquivo</label><input id=\"fileupload\" type=\"file\" name=\"UpdateIMG\" style=\"width: 100%\"\"><br>");
